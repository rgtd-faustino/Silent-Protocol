...
- [1 Introdução](#1-introdução)
  - [1.1 Declaração de Uso de Inteligência Artificial Generativa](#11-declaração-de-uso-de-inteligência-artificial-generativa)
  - [1.2 Enquadramento Ético](#12-enquadramento-ético)
  - [1.3 O Caso Real que Inspirou o Projeto](#13-o-caso-real-que-inspirou-o-projeto)
  - [Da Realidade para a Nexus Corp](#da-realidade-para-a-nexus-corp)
- [2 Trabalho Relacionado](#2-trabalho-relacionado)
  ...
  - [Fallout](#fallout)
- [3 Modelo Proposto](#3-modelo-proposto)
  - [3.1 Requisitos](#31-requisitos)
  - [3.2 Fundamentos](#32-fundamentos)
  - [3.3 Abordagem](#33-abordagem)
  - [3.4 Edifício](#34-edifício)
    - [Receção](#receção)
    - [Executivo](#executivo)
    ...
    - [CEO](#ceo)
  - [3.5 NPC](#35-npc)
    - [Roles de NPC](#roles-de-npc)
    - [Sistema de Rotas](#sistema-de-rotas)
    - [Sistema de Deteção](#sistema-de-deteção)
  - [3.6 Intel](#36-intel)
  - [3.7 Tarefas Diárias](#37-tarefas-diárias)
    - [Escrever Documento](#escrever-documento)
    - [Arquivar Documento](#arquivar-documento)
    - [Imprimir Documento](#imprimir-documento)
    - [Entregar Documento](#entregar-documento)
  - [3.8 Mini Jogos](#38-mini-jogos)
    - [Mini Jogo 1 - Acesso a Câmaras de Vigilância](#mini-jogo-1-acesso-a-câmaras-de-vigilância)
    - [Mini Jogo 2 - Escuta de Reunião](#mini-jogo-2-escuta-de-reunião)
    - [Mini Jogo 3 - Escuta de Telefonemas](#mini-jogo-3-escuta-de-telefonemas)
    - [Mini Jogo 4 - Captura de Pacotes de Rede](#mini-jogo-4-captura-de-pacotes-de-rede)
  - [3.9 Design e Identidade Visual](#39-design-e-identidade-visual)
- [4 Implementação do Modelo](#4-implementação-do-modelo)
  - [4.1 Implementação da Identidade Visual e Atmosfera](#41-implementação-da-identidade-visual-e-atmosfera)
    - [Iluminação Dinâmica e Rotação Solar](#iluminação-dinâmica-e-rotação-solar)
    - [HUD Dinâmico de Suspeita](#hud-dinâmico-de-suspeita)
    - [Simulação Dinâmica de Sono e Fadiga](#simulação-dinâmica-de-sono-e-fadiga)
    - [Estilo e Comportamento do Computador](#estilo-e-comportamento-do-computador)
  - [4.2 Mini Jogos](#42-mini-jogos)
    - [Mini Jogo 1 - Acesso a Câmaras de Vigilância](#mini-jogo-1-acesso-a-câmaras-de-vigilância)
    - [Mini Jogo 2 - Escuta de Reunião](#mini-jogo-2-escuta-de-reunião)
    - [Mini Jogo 3 - Escuta de Telefonemas](#mini-jogo-3-escuta-de-telefonemas)
    - [Mini Jogo 4 - Captura de Pacotes de Rede](#mini-jogo-4-captura-de-pacotes-de-rede)
    - [Mini Jogo 5 - Descodificação e Desencriptação](#mini-jogo-5-descodificação-e-desencriptação)
  - [4.3 Intel](#43-intel)
    - [Recolha de Informação - OSINT, Engenharia Social e Forense Digital](#recolha-de-informação-osint-engenharia-social-e-forense-digital)
  - [4.4 Tarefas Diárias](#44-tarefas-diárias)
    - [Escrever Documento](#escrever-documento)
    - [Arquivar Documento](#arquivar-documento)
    - [Entregar Documento](#entregar-documento)
  - [4.5 NPC](#45-npc)
...
- [5 Validação e Testes](#5-validação-e-testes)
  - [5.1 Testes X](#51-testes-x)
  - [5.2 Testes Y](#52-testes-y)
- [6 Conclusões e Trabalho Futuro](#6-conclusões-e-trabalho-futuro)
  - [6.1 Conclusões](#61-conclusões)
  - [6.2 Trabalho Futuro](#62-trabalho-futuro)
- [Apêndice A - Gestão de Versões](#apêndice-a-gestão-de-versões)
- [Apêndice B - Estrutura de Entrega](#apêndice-b-estrutura-de-entrega)
...
## 1.1 Declaração de Uso de Inteligência Artificial Generativa

De acordo com as diretrizes da unidade curricular, declaramos a utilização de modelos de Inteligência Artificial Generativa como ferramenta de apoio. A IA foi empregue unicamente sob nossa direção crítica, assumindo as seguintes funções:
1. **Documentação e Relatório Técnico:** A estruturação, formatação e revisão ortográfica/sintática de todo o relatório foram apoiadas por IA. Contudo, a IA atuou apenas como redator de informações técnicas fornecidas integralmente por nós. Todo o texto gerado foi cuidadosamente lido, escrutinado e alterado para garantir que espelha exatamente a implementação real em código e as decisões de *Game Design* que tomámos. Nada foi aceite às cegas; assumimos total responsabilidade técnica sobre o conteúdo final.
2. **Criação da Narrativa e *Lore*:** A IA foi utilizada como co-argumentista para expandir as ideias base da história e redigir a componente textual dos minijogos, interações e documentos *in-game*. Toda a direção narrativa e os temas abordados foram definidos por nós e adaptados para encaixar nas mecânicas do jogo.

O uso da IA libertou tempo na redação extensiva, permitindo o nosso foco total na arquitetura lógica, nas mecânicas de *gameplay* (programadas em C#) e na construção dos sistemas dentro do Unity.

## 1.2 Enquadramento Ético
...
## 1.3 O Caso Real que Inspirou o Projeto
...
**O Caso Cambridge Analytica.** Em 2013, através da aplicação de testes de personalidade "*This Is Your Digital Life*", o investigador Aleksandr Kogan recolheu dados de cerca de 270 mil utilizadores voluntários \[1\]. Contudo, tirando partido de permissões da API Graph do Facebook, a recolha estendeu-se aos dados de todos os amigos desses utilizadores, sem o seu consentimento. O resultado foi a exfiltração de perfis de cerca de 87 milhões de utilizadores \[2\], cujos dados foram transferidos para a consultora política Cambridge Analytica para traçar perfis psicográficos e direcionar publicidade política segmentada em campanhas eleitorais \[7\]\[8\]. A exposição do caso em 2018 resultou em multas sem precedentes ao Facebook \[5\]\[6\] e na falência da consultora \[3\].

**O Caso da VPN Onavo.** Em 2013, o Facebook adquiriu a empresa israelita Onavo e disponibilizou a aplicação "Onavo Protect", promovida como uma ferramenta gratuita de segurança e privacidade (VPN) \[9\]. A aplicação foi descarregada por mais de 33 milhões de utilizadores. Contudo, ao canalizar o tráfego de rede dos dispositivos pelos seus servidores, a aplicação permitiu ao Facebook monitorizar de forma passiva a atividade dos utilizadores, identificando que aplicações concorrentes estavam a crescer. Estes dados serviram de inteligência concorrencial, influenciando decisões como a aquisição do WhatsApp em 2014 e o lançamento das Instagram Stories em 2016 para conter o Snapchat. A aplicação foi removida da App Store em 2018 por violação das políticas da Apple \[10\]\[11\]\[12\].
...
**Requisitos funcionais.** O requisito central do projeto era permitir uma dupla vida dentro do edifício onde o jogador cumpre tarefas de trabalho legítimas enquanto recolhe e utiliza informação de forma discreta. Desse requisito central resultaram os pontos apresentados em seguida.
...
**Requisitos não funcionais.** O jogo tinha de correr de forma fluida em computadores modestos, o que levou à escolha de um mundo em baixo polígono e de cenários contidos. Tinha também de manter o jogador sempre informado do seu estado através de um HUD permanente e claro, composto pela barra de suspeita, pelo indicador de carga da lanterna e pelo gestor visível de tarefas ativas. A fadiga acumulada é representada de forma puramente orgânica e sensorial através de sobreposições de ecrã (como piscares involuntários e blackouts progressivos), ao passo que o ruído sonoro produzido pelas ações do jogador funciona de forma diegética na interação com o cenário e a audição dos guardas, sem recorrer a barras de estado artificiais na interface.
...
A arquitetura do jogo organiza-se em torno de um conjunto de sistemas centrais, cada um responsável por uma camada distinta da experiência. O sistema principal mantém o estado global, o ciclo dia-noite, o progresso narrativo e trata da gravação automática. Um sistema visual centraliza os indicadores no ecrã, os menus e as interfaces de computador. O controlo da personagem gere o movimento, a interação com o cenário, a lanterna e o ruído produzido, registando simultaneamente as suspeitas geradas diretamente pelas ações do jogador. A inteligência artificial coordena as rotinas, patrulhas, reações a alertas e os diálogos das personagens não jogáveis. O ciclo de obrigações profissionais é mantido por um gestor de tarefas, enquanto cada minijogo opera de forma independente, validando o sucesso ou a falha das interações e atribuindo as respetivas recompensas.

O sistema de suspeita foi implementado como uma métrica global partilhada entre o controlo do jogador e a inteligência artificial. Esta métrica sobe com ações como falhar tarefas, permanecer em áreas restritas, usar câmaras de forma excessiva ou ser visto a aceder a terminais fora do posto de trabalho, e desce com o cumprimento de tarefas e com comportamento social neutro dentro do horário normal. Ao atravessar os limiares de atenção e de investigação, as personagens e os guardas alteram as suas rotinas e aumentam as patrulhas, tornando o risco cada vez mais evidente em vez de terminar o jogo logo ao primeiro erro. O teclado numérico de acesso segue esta mesma lógica, com um limite de tentativas ligado à suspeita, pelo que forçar um código repetidamente tem custo direto no resto do jogo.
...
O sistema de rotas de NPC envolve múltiplas variáveis que têm de ser coordenadas em simultâneo. Estas incluem o tipo de NPC, o piso em que opera, o modo de seleção de rota (fixa, aleatória ou forçada por evento) e o comportamento de regressão ao ponto de partida. Cada tipo de NPC tem um conjunto de rotas próprio definido no seu perfil, e alguns tipos podem partilhar rotas mediante configuração no objeto de patrulha. A seleção de uma rota entre as disponíveis inclui uma componente de probabilidade, introduzindo imprevisibilidade no comportamento observado.
...
* **OSINT (Open Source Intelligence)** consiste na recolha de informação estrategicamente relevante a partir de fontes públicas ou de livre acesso \[33\]\[34\]. Em *Silent Protocol*, o jogador aplica este princípio de forma passiva, visto que a maior parte da informação não exige invasão técnica de sistemas, mas sim a procura atenta por papéis esquecidos em secretárias, impressoras ou e-mails abertos em postos de trabalho desbloqueados \[35\]\[36\].
* **Engenharia Social (Elicitação e Pretexting)** explora o fator humano para obter acessos \[38\]\[41\]. A própria posição do jogador como funcionário júnior é um exercício de *pretexting*, em que se recorre a uma identidade falsa para gerar confiança. Através do sistema de diálogos, o jogador interage com os NPC e usa o pretexto de ser um colega inexperiente ou refere pistas previamente encontradas para manipular os diálogos (elicitação) e extrair credenciais, rotinas e segredos \[47\].
* **Dumpster Diving** assenta na recuperação de dados sensíveis a partir de lixo físico ou digital \[45\]\[46\]. No jogo, manifesta-se ao explorar os caixotes de lixo nos gabinetes e a reciclagem ("Trash Can") dos computadores dos NPC, onde informação confidencial apagada ou descartada por negligência pode ser recuperada.
...
**A Vulnerabilidade do HTTP.** O HTTP (*Hypertext Transfer Protocol*) é o protocolo que serve de base à web \[15\]\[17\]. O aspeto de interesse pedagógico para o jogo reside no facto de o HTTP original transmitir os dados em texto simples (*cleartext*), o que permite a qualquer nó intermédio com acesso à rede local ler o conteúdo completo das mensagens \[16\]. Embora sistemas modernos utilizem HTTPS (encriptando os dados via TLS), redes internas antigas ou mal configuradas podem manter tráfego em texto simples vulnerável \[29\].

**O Wireshark e o Modo Promíscuo.** O Wireshark é a ferramenta real utilizada por administradores e auditores de segurança para capturar e analisar tráfego \[20\]\[21\]. O seu funcionamento baseia-se em colocar a placa de rede em modo promíscuo (*promiscuous mode*). Se em condições normais uma placa apenas processa pacotes endereçados ao seu computador, no modo promíscuo ela passa a capturar e a expor todo o tráfego físico que passa pela interface de rede, independentemente do destinatário \[23\].
...
A desencriptação e descodificação de dados intercetados representa a fase subsequente da análise forense no *Silent Protocol*. A interceção passiva efetuada no analisador de pacotes de rede apenas recolhe dados brutos cifrados ou codificados, os quais necessitam de ser processados no terminal pessoal do jogador para extrair informação legível de valor estratégico.

**DES e a fragilidade histórica.** O DES (*Data Encryption Standard*) foi adotado em 1976 e utiliza uma chave de 56 bits \[27\]. O seu aspeto mais relevante reside no facto de ilustrar a evolução computacional, considerando que, embora fosse seguro nos anos 70, em 1999 a organização EFF provou ser possível quebrar a sua chave por força bruta em menos de 23 horas, tornando-o obsoleto para sistemas modernos \[28\].

**AES e a robustez do Rijndael.** Para suceder ao DES, foi selecionado em 2001 o algoritmo Rijndael (AES, sigla para *Advanced Encryption Standard*), criado por dois criptógrafos belgas \[24\]\[25\]. Operando com chaves de 128 a 256 bits, a sua segurança é tão elevada que uma chave de 128 bits apresenta 2^128 combinações possíveis, exigindo mais tempo do que a idade do universo para ser decifrada por força bruta com a tecnologia atual \[26\].
...
## 3.9 Design e Identidade Visual
...
A transição atmosférica é controlada pelo script `DayNightLightController.cs`, que calcula a hora do dia através do relógio central do `TimeManager`. O comportamento assenta nas parametrizações descritas a seguir.
...
O indicador de furtividade é gerido pelo script `SuspicionHUD.cs` e implementa as regras visuais descritas em seguida.
...
### Simulação Dinâmica de Sono e Fadiga

Os efeitos físicos da privação de sono no jogador são processados pelo script `SleepOverlay.cs` em coordenação com o `TimeManager.cs` #my_code. A fadiga acumulada desencadeia alterações graduais na perceção visual da personagem através das lógicas de código descritas a seguir.
* **Transições Visuais.** O script controla a opacidade de uma sobreposição preta no ecrã através do método `FadeOverlay`, aplicando atenuações lineares e suavizações quadráticas de aproximação (`EaseInQuad`, `EaseOutQuad`).
* **Estágios de Privação.** No nível leve (estágio 1), inicia-se a rotina `BlinkLoop` que simula o fecho involuntário das pálpebras através de desvanecimentos periódicos. No nível moderado (estágio 2), corre a rotina `BlackoutLoop` que gera cortes de visão temporários e avança o tempo de jogo de forma descontrolada. No nível severo (estágio 3), a rotina `Stage3Sequence` apaga a visão de forma definitiva, forçando o desmaio da personagem.
...
Os ficheiros de código que implementam este minijogo são “[CameraHackInteractable.cs](http://CameraHackInteractable.cs)”, “[CameraHackPuzzle.cs](http://CameraHackPuzzle.cs) #my_code”, “[CameraSystem.cs](http://CameraSystem.cs)”, “CameraTerminal.cs” , “[CameraViewUI.cs](http://CameraViewUI.cs)” e “[SurveillanceCamera.cs](http://SurveillanceCamera.cs)”.
...
Cada instância representa um único pacote de rede capturado, com os campos descritos a seguir.
...
Este mini-jogo é composto por dois scripts principais que residem no mesmo GameObject, o terminal do computador do jogador. “[TerminalManager.cs](http://TerminalManager.cs)” e “[TerminalUI.cs](http://TerminalUI.cs)”. A estes junta-se um componente estático auxiliar “[CryptoHelper.cs](http://CryptoHelper.cs) #my_code”, que concentra toda a lógica criptográfica, e uma ligação direta ao “GameClipboard.cs” , o componente que transporta os pacotes capturados no Mini-Jogo 4 para dentro desse terminal.
...
O ficheiro de código que implementa esta tarefa é “NPCScript.cs”, mais especificamente a sua lógica de “Interact” e o método privado “TryDeliverDocument”, em conjunto com o campo “correctRecipientID” guardado no “DocumentTaskData.cs”.
...
**Identificação**  
Os NPC (*Non Playable Characters*) são fundamentais para o ecossistema do *Silent Protocol*, conferindo vida ao edifício e atuando como o principal obstáculo e fonte de informação para o jogador. O sistema de NPC engloba a gestão do ciclo de vida destas personagens (instanciação e abate), a navegação por rotas complexas ao longo dos diferentes pisos, a capacidade de reação ao comportamento do jogador (sistema de suspeita e ruído) e um sistema de diálogo interativo que permite a obtenção de pistas e informações narrativas.

**Estrutura de dados**  
O ecossistema dos NPC é implementado através de um conjunto alargado de ficheiros. O comportamento individual e a navegação são geridos pelos scripts `NPCScript.cs` #my_code e `PatrolRoute.cs` #my_code. A orquestração global é assegurada pelo `NPCManager.cs` #my_code e pelo `NPCSpawner.cs`. O sistema de diálogo é suportado pelo `DialogueManager.cs`, utilizando modelos de dados baseados em ScriptableObjects como `NPCDialogueData.cs`, `DialogueTopic.cs` e `DialogueCutscene.cs`. O sistema interage ainda com dependências externas fundamentais, designadamente `SuspicionManager.cs` #my_code, `TimeManager.cs`, `TaskManager.cs` #my_code e `GameEvent.cs` #my_code.

**Deteção de início**  
O fluxo de dados inicia-se no `NPCManager.cs`, que atua como controlador central de rotas e presenças por piso. Este gestor informa o `NPCSpawner.cs` sobre as necessidades de instanciação de novas personagens, respeitando limites predefinidos. Uma vez instanciado, o `NPCScript.cs` de cada personagem consulta o gestor para obter uma `PatrolRoute.cs` válida, movimentando-se pelo cenário. Em paralelo, o `NPCScript.cs` escuta eventos do `SuspicionManager.cs` para alterar o seu estado (Atenção, Investigação ou Perseguição). Quando o jogador interage com um NPC, o fluxo é transferido para o `DialogueManager.cs`, que lê a configuração do `NPCDialogueData.cs` da personagem específica e apresenta as opções na interface do utilizador, avaliando o carisma e a suspeita do jogador para determinar que tópicos (`DialogueTopic.cs`) ficam disponíveis.

**Lógica central em execução**  
A lógica de navegação assenta num repositório centralizado de rotas no `NPCManager.cs`, organizadas por piso. O mapeamento obedece a um forte racional de *Game Design* para garantir que o comportamento das personagens se ajusta à narrativa do escritório:
* No **Piso 1 (Receção)**, os visitantes e o único guarda limitam-se a patrulhar (*VAGUEAR*). As rececionistas alternam entre *DESCANSAR*, *ENCHER_AGUA* e *LIMPAR_LIXO* para simular atividade rotineira. Os colegas de outros pisos usam *CAMINHO1* ou *CAMINHO2* exclusivamente para transitar entre a porta principal e os elevadores.
* No **Piso 2 (Executivo)**, a complexidade aumenta. Todos partilham a rota *VAGUEAR*, mas os colegas e o chefe de departamento possuem rotas específicas de socialização inter e intra-departamental (*FalarD1*, *FalarD2*, etc.), bem como rotinas de pausa para alimentação. Isto cria um fluxo denso de pessoas que o jogador tem de evitar ou com as quais tem de interagir cautelosamente.
* Nos **Pisos 3, 4 e 5**, o tráfego é progressivamente mais restrito. No Piso 4 (Apartamentos), os colegas executam *VAGUEAR_START_ROUTE* antes de se fecharem nos respetivos quartos. O CEO, no último andar, mantém um padrão isolado de *VAGUEAR*.
Cada `PatrolRoute.cs` expõe variáveis de configuração críticas no Inspector do Unity, definindo a probabilidade da sua seleção (introduzindo imprevisibilidade orgânica), se a rota decorre em *loop*, e se é considerada uma rota de descanso. O `NPCSpawner.cs` complementa esta lógica atribuindo rotas iniciais de entrada (`startRoute`) e rotas fixas (`assignedRoute`). Adicionalmente, o sistema suporta eventos dinâmicos; durante o período da tarde, o `NPCManager.cs` seleciona os NPC relevantes do piso Executivo e força a substituição das suas rotas habituais, encaminhando-os para o espaço de reuniões, através do método `ForceRoute`. 

**Ligação a outros sistemas**  
A complexidade subjacente a este sistema traduz-se numa experiência de simulação de escritório credível, onde as personagens apresentam comportamentos dinâmicos. O jogador não pode assumir padrões perfeitamente estáticos, necessitando de observar as rotinas diárias e adaptar-se aos eventos dinâmicos (como a reunião do executivo). O sistema de diálogo recompensa a gestão cuidada da métrica de suspeita e a exploração prévia, uma vez que a disponibilidade de certas opções de conversa depende diretamente do estado atual do mundo e do perfil da personagem abordada.
...
* **Expansão das Mecânicas de Infiltração:** Introduzir novos métodos de locomoção e ocultação para o jogador, como a capacidade de se esconder dentro de estruturas do cenário (armários ou condutas de ventilação) e a criação de distrações sonoras dinâmicas, atirando objetos para desviar a atenção dos guardas de forma mais tática.
* **Complexidade da Inteligência Artificial:** Desenvolver uma rede de comunicação entre os NPC. Atualmente, os estados de investigação são largamente individuais; o objetivo futuro seria permitir que os guardas chamassem reforços e realizassem buscas coordenadas nas áreas suspeitas, aumentando exponencialmente o desafio.
* **Diversidade de Puzzles e Cibersegurança:** Expandir o leque de minijogos para abranger outros vetores de ataque comuns em espionagem corporativa. Exemplos incluem simulações de *phishing* interativo no cliente de e-mail do jogo, ou mecânicas de quebra de palavras-passe através de ataques de dicionário simplificados, consolidando o caráter educativo da obra.
* **Voz e Imersão Narrativa:** Substituir os diálogos puramente textuais por um sistema integral com gravação de voz (*voice acting*). Esta melhoria reforçaria substancialmente a imersão do jogador nas interações com os colegas e na caracterização psicológica dos chefes de departamento e do CEO.

# Apêndice A - Gestão de Versões
...
# Apêndice B - Estrutura de Entrega

O repositório do projeto foi organizado segundo a estrutura oficial de entrega da unidade curricular, separando a documentação, o planeamento e o código em pastas numeradas. Devido ao limite de tamanho do repositório, o executável e o projeto integral do Unity foram hospedados externamente. A estrutura principal encontra-se organizada da seguinte forma:

* **00_Planeamento/** contém o cronograma de desenvolvimento do projeto, detalhando as fases de conceção, implementação e testes.
* **01_Analise/** centraliza o levantamento de requisitos funcionais e não funcionais, bem como os diagramas de casos de utilização.
* **02_Desenho/** inclui o *Game Design Document* original (*GDD - Silent Protocol.pdf*), que serviu de guião para a conceção artística, mecânica e narrativa do protótipo.
* **03_Implementacao/** contém exclusivamente o código-fonte desenvolvido (*Assets/Scripts/*) e os ficheiros de dados configuráveis (*Assets/ScriptableObjects/*) importados do projeto Unity, de modo a permitir a avaliação técnica sem o peso dos recursos gráficos e sonoros associados.
* **04_Teste/** reserva-se aos guiões e resultados de testes efetuados ao protótipo final.
* **_RELATORIO.pdf** e **_README.TXT** encontram-se na raiz, detalhando o conteúdo do repositório e indicando a hiperligação externa para o vídeo de demonstração e para as versões jogáveis.
